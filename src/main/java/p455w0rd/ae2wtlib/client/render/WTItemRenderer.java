 ...
 *
 */
public class WTItemRenderer extends TileEntityItemStackRenderer {
	...
	public void renderByItem(ItemStack stack, float partialTicks) {
		...
		GlStateManager.alphaFunc(516, 0.99F);
	...
	public WTItemRenderer setModel(ItemLayerWrapper wrappedModel) {
		model = wrappedModel;
		return this;
	}
