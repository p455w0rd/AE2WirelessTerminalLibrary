 ...
 *
 */
public class GuiItemIconButton extends GuiButton implements ITooltip {
	...
	public GuiItemIconButton(final int xIn, final int yIn, final int ico, final String message, final RenderItem ir) {
		super(0, 0, 16, "");
	...
	public GuiItemIconButton(final int xIn, final int yIn, final ItemStack ico, final String message, final RenderItem ir) {
		super(0, 0, 16, "");
		x = xIn;
		y = yIn;
		width = 22;
